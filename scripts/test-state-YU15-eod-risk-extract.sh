...
EXPECTED_STATE="YU15-eod-risk-extract"
...
rg -q '"id": "YU15-eod-risk-extract"' "${REPO_ROOT}/catalog/state-catalog.json"
[[ -x "${GENERATED_ROOT}/code/target-generated/scripts/start-state-YU15-eod-risk-extract-generated.sh" ]]
[[ -x "${GENERATED_ROOT}/code/target-generated/scripts/stop-state-YU15-eod-risk-extract-generated.sh" ]]
[[ -x "${GENERATED_ROOT}/code/target-generated/scripts/status-state-YU15-eod-risk-extract-generated.sh" ]]

echo "[done] YU15-eod-risk-extract generated-state scaffold checks passed"
