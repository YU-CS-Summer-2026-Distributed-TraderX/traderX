...
echo "[info] harness; only order-matcher + trade-processor images carry the post-trade-compliance"
echo "[info] overlay, plus the database-init ConfigMap gains a settlementdate column."
