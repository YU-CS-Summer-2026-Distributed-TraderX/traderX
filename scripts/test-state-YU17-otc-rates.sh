...
rg -q '"id": "YU17-otc-rates"' "${REPO_ROOT}/catalog/state-catalog.json"
[[ -x "${GENERATED_ROOT}/code/target-generated/scripts/start-state-YU17-otc-rates-generated.sh" ]]
[[ -x "${GENERATED_ROOT}/code/target-generated/scripts/stop-state-YU17-otc-rates-generated.sh" ]]
[[ -x "${GENERATED_ROOT}/code/target-generated/scripts/status-state-YU17-otc-rates-generated.sh" ]]

echo "[done] YU17-otc-rates generated-state scaffold checks passed"
