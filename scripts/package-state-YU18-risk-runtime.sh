...
cp "$ROOT"/specs/YU18-risk-integration/generation/runtime-overrides/eod-risk-bundles/*.py "$STAGE/eod-risk-bundles/"
cp "$ROOT/specs/YU18-risk-integration/generation/runtime-overrides/eod-risk-bundles/container-result-schema.json" "$STAGE/eod-risk-bundles/"
cp "$ROOT/specs/YU18-risk-integration/generation/runtime-overrides/eod-risk-bundles/requirements-container.txt" "$STAGE/eod-risk-bundles/"
