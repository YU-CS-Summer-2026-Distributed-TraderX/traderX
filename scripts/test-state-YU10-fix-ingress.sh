...
EXPECTED_STATE="YU10-fix-ingress"
...
[[ -f "${REPO_ROOT}/specs/YU10-fix-ingress/system/dr-runbook.md" ]] || { echo "[error] missing system/dr-runbook.md"; exit 1; }
...
echo "[done] YU10-fix-ingress generated-state smoke checks passed"
