...
EXPECTED_STATE="YU13-limit-order-book"
...
rg -q '"id": "YU13-limit-order-book"' "${REPO_ROOT}/catalog/state-catalog.json"
[[ -x "${GENERATED_ROOT}/code/target-generated/scripts/start-state-YU13-limit-order-book-generated.sh" ]]
[[ -x "${GENERATED_ROOT}/code/target-generated/scripts/stop-state-YU13-limit-order-book-generated.sh" ]]
[[ -x "${GENERATED_ROOT}/code/target-generated/scripts/status-state-YU13-limit-order-book-generated.sh" ]]

echo "[done] YU13-limit-order-book generated-state scaffold checks passed"
