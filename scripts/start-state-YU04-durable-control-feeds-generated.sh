...
UPSTREAM_START_SCRIPT="${GENERATED_ROOT}/code/target-generated/scripts/start-state-YU03-in-memory-risk-gateway-generated.sh"
...
echo "[info] ${STATE_ID} reuses the YU03-in-memory-risk-gateway (=> YU02 => state-014) runtime"
echo "[info] harness; only order-matcher/account-service/reference-data image content differs."
