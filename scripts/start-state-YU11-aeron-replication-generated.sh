...
echo "[info] ${STATE_ID} reuses the complete YU10 runtime harness and overlays dual-capable"
echo "[info] NATS/Aeron BLP replication, per-pod Archive sidecars, exact journal watermarks,"
echo "[info] degraded/strict follower-loss policy, and Lease/fast-witness failover selection."
