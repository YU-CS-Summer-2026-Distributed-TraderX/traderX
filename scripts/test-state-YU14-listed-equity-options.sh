...
EXPECTED_STATE="YU14-listed-equity-options"
...
rg -q '"id": "YU14-listed-equity-options"' "${REPO_ROOT}/catalog/state-catalog.json"
[[ -x "${GENERATED_ROOT}/code/target-generated/scripts/start-state-YU14-listed-equity-options-generated.sh" ]]
[[ -x "${GENERATED_ROOT}/code/target-generated/scripts/stop-state-YU14-listed-equity-options-generated.sh" ]]
[[ -x "${GENERATED_ROOT}/code/target-generated/scripts/status-state-YU14-listed-equity-options-generated.sh" ]]

echo "[done] YU14-listed-equity-options generated-state scaffold checks passed"
