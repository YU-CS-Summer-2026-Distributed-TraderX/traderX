...
echo "[info] ${STATE_ID} reuses the YU07-historical-tick-store (=> YU06 => YU05 => YU04 => YU03 =>"
echo "[info] YU02 => state-014) runtime harness; only the new execution-algo-engine component"
echo "[info] (TWAP/VWAP scheduler, REST API on 18120) is added, plus its own Deployment/Service"
echo "[info] manifests."
