...
EXPECTED_STATE="YU11-aeron-replication"
...
echo "[check] YU11 catalog and wrapper wiring"
rg -q '"id": "YU11-aeron-replication"' "${REPO_ROOT}/catalog/state-catalog.json"
[[ -x "${GENERATED_ROOT}/code/target-generated/scripts/start-state-YU11-aeron-replication-generated.sh" ]]
[[ -x "${GENERATED_ROOT}/code/target-generated/scripts/stop-state-YU11-aeron-replication-generated.sh" ]]
[[ -x "${GENERATED_ROOT}/code/target-generated/scripts/status-state-YU11-aeron-replication-generated.sh" ]]

echo "[done] YU11-aeron-replication generated-state scaffold checks passed"
