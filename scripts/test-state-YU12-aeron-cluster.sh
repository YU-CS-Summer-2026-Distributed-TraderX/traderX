...
EXPECTED_STATE="YU12-aeron-cluster"
...
rg -q '"id": "YU12-aeron-cluster"' "${REPO_ROOT}/catalog/state-catalog.json"
[[ -x "${GENERATED_ROOT}/code/target-generated/scripts/start-state-YU12-aeron-cluster-generated.sh" ]]
[[ -x "${GENERATED_ROOT}/code/target-generated/scripts/stop-state-YU12-aeron-cluster-generated.sh" ]]
[[ -x "${GENERATED_ROOT}/code/target-generated/scripts/status-state-YU12-aeron-cluster-generated.sh" ]]

echo "[done] YU12-aeron-cluster generated-state scaffold checks passed"
