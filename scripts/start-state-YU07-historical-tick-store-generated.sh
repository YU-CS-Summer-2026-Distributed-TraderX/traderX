...
echo "[info] ${STATE_ID} reuses the YU06-eod-price-production (=> YU05 => YU04 => YU03 => YU02 =>"
echo "[info] state-014) runtime harness; only the new tick-store component (capture.py NATS"
echo "[info] consumer + ingest_taq_quotes.py CLI, no HTTP surface) is added, plus its own"
echo "[info] Deployment/PVC manifests."
