...
public final class HotPathMetrics {
    ...
    private final ConcurrentHistogram riskDecisionNs = new ConcurrentHistogram(HIGHEST_TRACKABLE_NS, 3);
    ...
    public void recordRiskDecisionLatency(long nanos) {
        record(riskDecisionNs, nanos);
    }
    ...
    public ConcurrentHistogram riskDecisionHistogram() {
        return riskDecisionNs;
    }
