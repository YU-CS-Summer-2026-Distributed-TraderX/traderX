...
public class Trade implements Serializable {
  ...
  // YU05 (post-trade-compliance, FR-PTC02/06): set by the Projector at booking time
  // (created + settlement.t-plus-days business days); advanced to actual by trade-processor's
  // SettlementService sweep once state becomes Settled.
