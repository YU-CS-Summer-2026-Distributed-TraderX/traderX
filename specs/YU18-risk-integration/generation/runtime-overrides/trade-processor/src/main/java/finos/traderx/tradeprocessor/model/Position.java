...
public class Position implements Serializable {
  ...
  @Column(name = "AVERAGECOSTBASIS", precision = 18, scale = 6)
  ...
  public void setAverageCostBasis(BigDecimal averageCostBasis) {
    this.averageCostBasis = averageCostBasis == null ? null : averageCostBasis.setScale(6, RoundingMode.HALF_UP);
  }
  ...
  @Id @Column(name="PROJECTIONSCOPE",length=64)
  private String projectionScope="legacy-unknown";
  public String getProjectionScope() { return projectionScope; }
  public void setProjectionScope(String scope) { this.projectionScope=scope; }
}
