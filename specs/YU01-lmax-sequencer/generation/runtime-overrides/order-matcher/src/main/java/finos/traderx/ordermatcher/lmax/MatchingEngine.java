...
/**
 * The Business Logic Processor (state YU01): single thread, entirely in memory,
...
public final class MatchingEngine implements EventHandler<InputEvent> {
     ...
     *  that journal replay reconstructs the same state as the DB warm-start (state YU01, step 1). */
