# Messaging Subject Map: YU10-fix-ingress

This state adds no NATS subject (its new surface is the FIX endpoint listed at the end) — every entry below is carried forward unchanged from
`YU09-ops-hardening`.
