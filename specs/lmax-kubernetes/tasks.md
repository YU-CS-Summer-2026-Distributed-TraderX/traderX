# Tasks: lmax-kubernetes

## Phase 1: State Scaffold

- [x] Register `lmax-kubernetes` in the state catalog
- [x] Create `specs/lmax-kubernetes`
...
- [x] Seed `order-matcher` LMAX internals into `lmax-kubernetes` runtime overrides
- [x] Seed `trade-service` Gateway role into `lmax-kubernetes` runtime overrides
...
- [ ] Update generated runtime scripts and manifests for dedicated `lmax-kubernetes` lifecycle behavior
