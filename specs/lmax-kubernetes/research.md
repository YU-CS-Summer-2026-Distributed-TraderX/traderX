...
- `lmax-kubernetes` should be implemented as a new child state, not as a direct merge between unrelated branch histories.

## Open Research Questions

1. Which `009b` runtime overrides are still authoritative versus superseded in `lmax-kubernetes`?
