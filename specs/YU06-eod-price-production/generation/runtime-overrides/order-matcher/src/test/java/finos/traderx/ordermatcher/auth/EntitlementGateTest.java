...
/**
 * Forward-ported from YU05 on 2026-07-09. The entitlement gate on the order-admission path
 * (FR-PTC42/FR-IMRG30). Exercises the four meaningful states — disabled, no/invalid token,
 * entitled, not entitled — with real HS256 tokens minted by {@link JwtTokenMinter} and verified
 * by {@link JwtAuthenticator}, so the security decision is tested end to end (not against a mock).
 */
