 ...
 *
 * <p>Forward-ported from YU05 on 2026-07-09: the Authorization header is threaded to the
 * entitlement gate so the market-trade command path is authn-gated on the same footing as
 * order submission.
 */
@RestController
@RequestMapping("/")
