...
/**
 * Forward-ported from YU05 (commit 70b5dee) to YU06 on 2026-07-09: YU06 forked from YU05 before
 * that commit landed, so its generated order-matcher had no entitlement check on the admission
 * path at all until this port. FR-PTC42 / FR-IMRG02 / FR-IMRG30: the entitlement gate on the
