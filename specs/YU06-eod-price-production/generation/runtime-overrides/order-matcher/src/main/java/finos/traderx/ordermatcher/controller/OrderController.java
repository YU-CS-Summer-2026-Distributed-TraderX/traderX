...
public class OrderController {
    ...
    // Forward-ported from YU05 on 2026-07-09: the Authorization header is threaded to the
    // service so the entitlement gate can resolve the caller's principal. Optional so the
    // header is absent-safe when entitlement enforcement is off (the default).
    @PostMapping("/orders")
