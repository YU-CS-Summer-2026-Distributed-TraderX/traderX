...
| Req | Status | Notes |
|---|---|---|
| NFR-EOD01 consistency: single source of truth | **Done** | Every consumer reads the same `(session_date, version)` snapshot; corrections create a new version, never an in-place edit. |
