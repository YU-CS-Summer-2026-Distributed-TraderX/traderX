...
class RiskExtractTest {
    ...
    void anUnmarkableRowRefusesToEmit() {
        ...
        final IllegalStateException e = assertThrows(IllegalStateException.class,
            () -> RiskExtractCsv.render(cut, Map.of(), counterparties(), stamp(cut, 9)));
    ...
    void aCutFromADifferentSequenceRefusesToEmit() {
        ...
        assertThrows(IllegalStateException.class,
            () -> RiskExtractCsv.render(cut, Map.of(), counterparties(), stamp(cut, 10)));
    }
    ...
    private String markAndCapture(final MatchingEngineClusteredService service) {
        ...
        final String cut = RiskExtractCut.render(service.lastExtractCutSeq(), SESSION.toEpochDay(),
            ...
            tickerById(service), id -> service.risk().contractMultiplier(id));
    ...
    private String[] tickerById(final MatchingEngineClusteredService service) {
        final String[] tickers = new String[MatchingEngineClusteredService.MAX_SECURITIES];
        for (final String ticker : new String[] { "AAPL", "AAPL260918C00240000" }) {
    ...
    private String render(final String cut) {
        return RiskExtractCsv.render(cut, marks(), counterparties(), stamp(cut, seqOf(cut)));
    }
