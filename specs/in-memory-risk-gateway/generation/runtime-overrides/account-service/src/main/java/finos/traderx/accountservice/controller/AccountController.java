...
public class AccountController {
  ...
  private final AccountControlFeedService controlFeed;

  public AccountController(AccountService accountService, AccountControlFeedService controlFeed) {
    this.accountService = accountService;
    this.controlFeed = controlFeed;
  }
  ...
  public ResponseEntity<Account> createAccount(@RequestBody Account account) {
    Account saved = accountService.upsertAccount(account);
    controlFeed.record(saved);
