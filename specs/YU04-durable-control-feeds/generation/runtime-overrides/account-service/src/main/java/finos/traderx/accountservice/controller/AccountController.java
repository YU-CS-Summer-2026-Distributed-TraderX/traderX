...
public class AccountController {
  ...
  public AccountController(AccountService accountService, AccountSnapshotService accountSnapshotService) {
  ...
  public ResponseEntity<ControlSnapshot> getControlSnapshot() {
    return ResponseEntity.ok(accountSnapshotService.snapshot());
  }
