...
export class TradeBlotterComponent implements OnChanges, OnDestroy {
    ...
    private readonly baseColumns: ColDef[] = [
        ...
        },
        {
            headerName: 'PRICE',
            field: 'price',
            // YU16 (FR-CDM17/27): a Treasury price is a fraction of par - display x100 with the
            // sign, no currency symbol; everything else keeps the currency format.
        ...
        },
        {
            ...
            // YU16 (FR-CDM23/27): the fail-closed reason, verbatim; empty for booked trades.
