...
- [x] T-OTC20: Run the inherited suite against this build. **23 passed, 0 skipped, 3 failed**, and
      ...
      `issues/resolved/HANDOFF-issue-historical-gateway-images-fail-the-probe-port.md`. Neither is a
...
- `issues/resolved/HANDOFF-issue-historical-gateway-images-fail-the-probe-port.md` — until the historical
