...
flowchart TB
  ...
  Sin_memory_risk_gateway["in-memory-risk-gateway: In-Memory Risk Gateway"]
  ...
  S009b_lmax_sequencer_architecture -.-> Sin_memory_risk_gateway
  ...
  click Sin_memory_risk_gateway href "/specs/in-memory-risk-gateway" "Open State in-memory-risk-gateway Spec Pack"
...
| [`in-memory-risk-gateway`](pathname:///specs/in-memory-risk-gateway) | [link](pathname:///specs/in-memory-risk-gateway) | [link](pathname:///specs/in-memory-risk-gateway/system/architecture) | [link](pathname:///specs/in-memory-risk-gateway/system/runtime-topology) | [link](pathname:///docs/learning/state-in-memory-risk-gateway) | [code/generated-state-in-memory-risk-gateway](https://github.com/finos/traderX/tree/code/generated-state-in-memory-risk-gateway) |
