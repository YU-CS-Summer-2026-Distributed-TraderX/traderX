...
STATE_SPEC_DIR="${ROOT}/specs/YU02-lmax-kubernetes"
GENERATED_ROOT="${TRADERX_GENERATED_ROOT:-${ROOT}/generated}"
TARGET_ROOT="${GENERATED_ROOT}/code/target-generated"
UPSTREAM_DIR="${TARGET_ROOT}/fdc3-intent-interoperability"
STATE_DIR="${TARGET_ROOT}/YU02-lmax-kubernetes"
SPEC_SOURCE_DIR="${STATE_DIR}/spec-source"
RUNTIME_OVERRIDES_DIR="${STATE_SPEC_DIR}/generation/runtime-overrides"

[[ -d "${UPSTREAM_DIR}" ]] || {
  echo "[fail] required state 014 artifact missing for YU02-lmax-kubernetes render: ${UPSTREAM_DIR}"
  exit 1
}
...
# YU02-lmax-kubernetes Generated Artifacts

This generated directory tracks the in-progress `YU02-lmax-kubernetes` forward port.

Parent lineage:

- inherited runtime reference: `generated/code/target-generated/fdc3-intent-interoperability`
- target state id: `YU02-lmax-kubernetes`
...
# YU02-lmax-kubernetes Implementation Status
