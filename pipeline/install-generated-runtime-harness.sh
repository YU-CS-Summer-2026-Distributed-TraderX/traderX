...
case "${STATE_ID}" in
  004-*|005-*|006-*|007-*|008-*|009-*|009b-*|010-*|011-*|012-*|013-*|014-*|YU02-lmax-kubernetes|YU03-in-memory-risk-gateway|YU04-durable-control-feeds|YU05-post-trade-compliance)
