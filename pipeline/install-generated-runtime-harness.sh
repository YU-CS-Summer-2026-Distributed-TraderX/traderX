...
case "${STATE_ID}" in
  ...
  YU09-ops-hardening)
    ...
    ;;
  YU10-fix-ingress|YU11-aeron-replication|YU12-aeron-cluster|YU13-limit-order-book|YU14-listed-equity-options)
    ...
    # model/risk multiplier without changing the run harness.
    copy_script_if_exists "start-state-010-kubernetes-runtime-generated.sh"
    copy_script_if_exists "stop-state-010-kubernetes-runtime-generated.sh"
    copy_script_if_exists "status-state-010-kubernetes-runtime-generated.sh"
    copy_script_if_exists "start-state-012-platform-convergence-c3-generated.sh"
    ...
    if [[ "${STATE_ID}" == "YU12-aeron-cluster" || "${STATE_ID}" == "YU13-limit-order-book" || "${STATE_ID}" == "YU14-listed-equity-options" ]]; then
    ...
    if [[ "${STATE_ID}" == "YU13-limit-order-book" || "${STATE_ID}" == "YU14-listed-equity-options" ]]; then
    ...
    if [[ "${STATE_ID}" == "YU14-listed-equity-options" ]]; then
