...
case "${STATE_ID}" in
  ...
  YU09-ops-hardening)
    ...
    ;;
  YU10-fix-ingress|YU11-aeron-replication|YU12-aeron-cluster|YU13-limit-order-book|YU14-listed-equity-options|YU15-eod-risk-extract|YU16-cdm-instruments|YU17-otc-rates|YU18-risk-integration)
    ...
    if [[ "${STATE_ID}" == "YU12-aeron-cluster" || "${STATE_ID}" == "YU13-limit-order-book" || "${STATE_ID}" == "YU14-listed-equity-options" || "${STATE_ID}" == "YU15-eod-risk-extract" || "${STATE_ID}" == "YU16-cdm-instruments" || "${STATE_ID}" == "YU17-otc-rates" || "${STATE_ID}" == "YU18-risk-integration" ]]; then
    ...
    if [[ "${STATE_ID}" == "YU13-limit-order-book" || "${STATE_ID}" == "YU14-listed-equity-options" || "${STATE_ID}" == "YU15-eod-risk-extract" || "${STATE_ID}" == "YU16-cdm-instruments" || "${STATE_ID}" == "YU17-otc-rates" || "${STATE_ID}" == "YU18-risk-integration" ]]; then
    ...
    if [[ "${STATE_ID}" == "YU14-listed-equity-options" || "${STATE_ID}" == "YU15-eod-risk-extract" || "${STATE_ID}" == "YU16-cdm-instruments" || "${STATE_ID}" == "YU17-otc-rates" || "${STATE_ID}" == "YU18-risk-integration" ]]; then
    ...
    if [[ "${STATE_ID}" == "YU15-eod-risk-extract" || "${STATE_ID}" == "YU16-cdm-instruments" || "${STATE_ID}" == "YU17-otc-rates" || "${STATE_ID}" == "YU18-risk-integration" ]]; then
    ...
    if [[ "${STATE_ID}" == "YU16-cdm-instruments" || "${STATE_ID}" == "YU17-otc-rates" || "${STATE_ID}" == "YU18-risk-integration" ]]; then
    ...
    if [[ "${STATE_ID}" == "YU17-otc-rates" || "${STATE_ID}" == "YU18-risk-integration" ]]; then
      ...
      if [[ "${STATE_ID}" == "YU18-risk-integration" ]]; then
        copy_script_if_exists "test-state-YU18-risk-integration.sh"
      fi
    fi
    ;;
esac
