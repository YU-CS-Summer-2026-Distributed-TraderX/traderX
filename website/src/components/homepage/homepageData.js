...
export const overviewCards = [
  ...
  },
  {
    ...
    description:
      'Every architectural claim is pinned by tests that run on each push, and the end-to-end proofs are built to fail — several caught real bugs before they passed.',
    tone: 'slate',
    icon: 'users',
  },
];
